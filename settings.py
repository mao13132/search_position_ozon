...
ID_SHEET = '1t2KaconNT7jbq6RCB86EWmDBzdB6WPPs8bY2nS3DUtM'
# ID_SHEET = '1Emwc-lwopwyBjNmtasvg8RemHmQM4iSKllQoUV9pM20'

BLACK_NAME = ["СилаНова", "Severli", "S'pets"]

NAME_SHEET = ['Benerich']  # Здесь можно ввести конкретные имена вкладок. Если список пустой [], то софт получит имена сам
